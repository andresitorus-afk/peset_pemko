...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // GIS Aset
        GisAset::create(['aset_id' => $a1->id, 'layer_id' => $layerTanah->id, 'latitude' => 3.5917, 'longitude' => 98.6753, 'tipe_geometri' => 'Polygon', 'luas_gis' => 5000, 'sumber_koordinat' => 'GPS', 'surveyed_at' => '2024-03-15 09:00:00']);
        GisAset::create(['aset_id' => $a2->id, 'layer_id' => $layerTanah->id, 'latitude' => 3.5850, 'longitude' => 98.6720, 'tipe_geometri' => 'Polygon', 'luas_gis' => 45000, 'sumber_koordinat' => 'Survey', 'surveyed_at' => '2024-04-20 10:30:00']);
        GisAset::create(['aset_id' => $a4->id, 'layer_id' => $layerBangunan->id, 'latitude' => 3.5920, 'longitude' => 98.6760, 'tipe_geometri' => 'Point', 'luas_gis' => 2500, 'sumber_koordinat' => 'GPS', 'surveyed_at' => '2024-05-10 14:00:00']);
        GisAset::create(['aset_id' => $a5->id, 'layer_id' => $layerBangunan->id, 'latitude' => 3.5780, 'longitude' => 98.6600, 'tipe_geometri' => 'Point', 'luas_gis' => 800, 'sumber_koordinat' => 'GoogleMaps', 'surveyed_at' => '2024-06-01 08:00:00']);
